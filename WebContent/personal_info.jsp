			...
			<div class="container-fluid">
				...
				<form class="col-xs-6 col-xs-offset-3" action="${pageContext.servletContext.contextPath}/NewsAddServlet" method="post">
					...
					<div class="form-group">
						<label>用户名:</label>
						<input type="text" class="form-control" name="uname" value="" readonly/>
					</div>
					<div class="form-group">
						<label>密码:</label>
						<input type="text" class="form-control" name="upwd" value=""/>
					</div>					
					<div class="form-group">
						<button type="submit" class="btn btn-success" onclick="">确认修改</button>
					</div>
